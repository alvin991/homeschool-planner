...
export function TreeItemComponent({ item, depth, showInsertBefore }: TreeItemComponentProps) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div ref={setNodeRef} style={{ ...style, ...folderOverlayStyle }} {...attributes} {...listeners}>
