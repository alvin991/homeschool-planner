  ...
  return (
    <div className="flex justify-center h-full p-6">
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-400">The name of this scheduled item</p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1 block w-full rounded-lg border-gray-200 bg-gray-50 px-4 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-300"
        />
        <p className="mt-1 text-xs text-gray-400">Brief description of what this item covers</p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-gray-400">Main content and activities for the student</p>
      </div>
